...
def run_joana(REV_GIT_PATH, REV_REPORTS_PATH, REV_SDGS_PATH, revContribs, heapStr, libPaths):
	...
	baseCmd += " \"" +libPaths + "\""
	#print baseCmd
	ignoreExceptions=["true"]#["true", "false"]
	...
	precisionsIds = [0]#xrange(8)#[0,1,2,3,4,5,6,7]
	...
	for ignoreException in ignoreExceptions:
		...
		for i in precisionsIds:
			run_joana_config(ignoreException, i, precisions, cmde, initialPrecisionMsg, REV_REPORTS_PATH)
#ignoreException = "false"
#cmde = baseCmd + " \"" + initialExceptionMsg + ignoreException + "\""
#print "Ignore Exceptions: "+str(ignoreException)
#run_joana_config(ignoreException, 1, precisions, cmde, initialPrecisionMsg, REV_REPORTS_PATH)

def run_joana_config(ignoreException, i, precisions, cmde, initialPrecisionMsg, REV_REPORTS_PATH):
	import sys
	import os.path
...
def runJoanaForSpecificRevs():
	...
	REPORTS_PATH = CA_PATH + "/reports2"
	SDGS_PATH = CA_PATH + "/sdgs2"
	revList = readLines(CA_PATH + "/revList25-03")
